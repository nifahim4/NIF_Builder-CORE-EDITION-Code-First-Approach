...
namespace NIF_Builder.Controllers
{
    public class EquipmentsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("EquipmentID,EquipmentName")] Equipment equipment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("EquipmentID,EquipmentName")] Equipment equipment)
        {
